...
-- Seed initial data from hardcoded translations

-- Header / Brand
INSERT INTO site_content (section_key, content_ar, content_en, content_type, section_group) VALUES
...
('about.ourStoryDesc', 'جمعية منابع الخير مشهرة برقم ٨٤٨٢ لسنة ٢٠١٠ بالقاهرة. هي جمعية خيرية غير هادفة للربح تهدف إلى خدمة المجتمع من خلال برامج ومبادرات تنموية وإنسانية متكاملة. تنفذ الجمعية برامجها وفق إطار مؤسسي مسؤول يضمن استهداف المستفيدين بكفاءة وتحقيق أثر اجتماعي مستدام. نعمل على تمكين الأسر، تقديم الرعاية الصحية والاجتماعية، وحماية البيئة، إلى جانب الأنشطة الثقافية والعلمية والدينية.', 'Manabea Al-Khair Association is registered under No. 8482 of 2010 in Cairo. It is a non-profit charitable association that aims to serve the community through integrated developmental and humanitarian programs and initiatives. The association implements its programs according to a responsible institutional framework that ensures efficient targeting of beneficiaries and achieving sustainable social impact. We work to empower families, provide healthcare and social care, protect the environment, alongside cultural, scientific and religious activities.', 'text', 'about_story'),
...
('contact.closingMessage', 'في جمعية منابع الخير نؤمن أن التواصل الفعّال هو جسر أساسي لتعزيز الثقة والتعاون مع المجتمع. تواصلكم معنا يساعدنا على تقديم خدماتنا بشكل أفضل، ويمنحنا فرصة للعمل معًا في نشر الخير وتحقيق التنمية المستدامة.', 'At Manabea Al-Khair Association, we believe that effective communication is a fundamental bridge for building trust and cooperation with the community. Your contact with us helps us deliver our services better and gives us the opportunity to work together in spreading goodness and achieving sustainable development.', 'text', 'contact_services');

-- Donate Channels
INSERT INTO site_content (section_key, content_ar, content_en, content_type, section_group) VALUES
('donate.title', 'تبرع الآن, ساهم في رسم بصمة أمل', 'Donate Now, Help Shape a Story of Hope', 'text', 'donate_channels'),
('donate.subtitle', 'تبرعك يصنع فرقًا حقيقي. من مصادر طعام إلى رعاية صحية كل مساهمة تُسهم في تحسين حياة أسر وأفراد محتاجين. التبرعات تُدار بمسؤولية كاملة لتصل إلى المستفيدين بأسرع وقت', 'Your donation makes a real difference. From food to healthcare, every contribution helps improve the lives of needy families and individuals. Donations are managed with full responsibility to reach beneficiaries as quickly as possible.', 'text', 'donate_channels'),
...
('volunteer.desc', 'نرحب بالمتطوعين الراغبين في الانضمام لفرقنا في التوزيع، التدريب، التنظيم، والدعم اللوجيستي. نوفّر تدريبًا موجزًا وتوزيع مهام واضح يضمن الاستفادة القصوى للمتطوعين والمستفيدين.', 'We welcome volunteers wishing to join our teams in distribution, training, organization, and logistical support. We provide brief training and clear task assignments to ensure maximum benefit for volunteers and beneficiaries.', 'text', 'volunteer_areas'),
